  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-4xl px-4 sm:px-6 md:px-12 space-y-4 sm:space-y-6 md:space-y-8">
        <h1 className="text-3xl md:text-6xl font-extrabold leading-snug sm:leading-tight md:leading-tight">
          <span className="logo">ფუძემშენი</span>  - ჩვენ გთავაზობთ ხარისხიან პროდუქტს
        </h1>
        <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto">
          აარჩიეთ პროდუქტი ჩვენი კატალოგიდან ან შეუკვეთეთ თქვენთვის სასურველი პროდუქტი.
        </p>

        <div className="flex flex-col sm:flex-row justify-center gap-4 mt-4 sm:mt-6 md:mt-8 z-10 relative">
          <Link
            href="/products"
